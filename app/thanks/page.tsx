      ...
      <div className="mx-auto max-w-2xl px-4 py-16 text-center">
        ...
        {state === 'ok' && (
          <div>
            ...
            <Link href="/pro" className="mt-6 inline-flex rounded-xl bg-emerald-600 px-5 py-3 font-semibold text-white hover:bg-emerald-700">Ir a Platy Pro</Link>
          </div>
        )}
        {state === 'fail' && (
          <div>
            <h1 className="text-3xl font-extrabold">No pudimos confirmar el pago</h1>
            <p className="mt-3 text-slate-600">Si tu pago fue aprobado, vuelve a abrir este enlace desde el mismo navegador o escríbenos para activarte manualmente.</p>
